...
using System.IO;
using BaiThucHanh10.Controller;
...
namespace BaiThucHanh10
{
    public partial class quanLyTaiKhoan : System.Web.UI.Page
    {
        ...
        {
            var avatar = (txtAvatar.PostedFile != null) ? txtUsername.Value + Path.GetExtension(txtAvatar.PostedFile.FileName) : null;
        ...
        protected void btnSave_ServerClick(object sender, EventArgs e)
        {
            ...
            if (UserController.Insert(user))
            {
                if (user.avatar != null)
                {
                    txtAvatar.PostedFile.SaveAs(Server.MapPath($"~/images/{user.avatar}"));
                }
