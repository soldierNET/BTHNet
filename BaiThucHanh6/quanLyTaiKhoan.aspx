...
<body>
    ...
    <form id="form" runat="server">
        ...
        <div class="input-group">
            <label for="radMale"><input type="radio" name="gender" id="radMale" runat="server" selected="true" value="male"/>Nam</label>
            <label for="radFemale"><input type="radio" name="gender" id="radFemale" runat="server" value="female"/>Nữ</label>
        </div>
